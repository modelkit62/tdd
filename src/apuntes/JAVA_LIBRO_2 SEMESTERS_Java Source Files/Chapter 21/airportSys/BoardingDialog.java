...
class BoardingDialog extends AirportDialog
{
    private JPanel cityPanel = new JPanel();
    private JLabel jlbCity = new JLabel("enter destination city");
    private JTextField jtfCity = new JTextField(12);
    

    public BoardingDialog(JFrame frameIn, String titleIn,Airport airportIn)
    {
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        else
        {
          try
          {
            associatedAirport.readyForBoarding(flight, city);
            JOptionPane.showMessageDialog(this, "confirmation:\nflight "+flight+" boarding to "+city,"Information", JOptionPane.INFORMATION_MESSAGE);
            dispose();
          }
